...
class CompositeLoss(torch.nn.Module):
    ...
    def forward(self, x, t):
        ...
        #t_class_valid = torch.transpose(t_class_valid, 1, 4)
        ###############################################################################################################
        ...
        #x_class_valid = torch.transpose(x_class_valid, 1, 4)
        ###############################################################################################################
        ...
        #print('concentration')
        #print(x_confidence.size())
        #print(t_confidence.size())
        #print(l_confidence.size())
        ################################################################################################################
        l_class = self.ce_loss(x_class_valid, t_class_valid)
        #print('class')
        #print(x_class_valid.size())
        #print(t_class_valid.size())
        #print(l_class)
        ################################################################################################################
