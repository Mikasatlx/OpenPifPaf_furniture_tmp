...
/////////////////////////////////////////////////////////////
                ...
                v1 = cif_field_a[f][2][j][i];
                v2 = cif_field_a[f][3][j][i];
                v3 = cif_field_a[f][4][j][i];
                v4 = cif_field_a[f][5][j][i];
...
////////////////////////////////////////////////////////////////////////////////
    ...
    for (int64_t i=0; i < n_seeds; i++) {
        ...
        seed_tensor_a[i][1] = seeds[i].v1;
        seed_tensor_a[i][2] = seeds[i].v2;
        seed_tensor_a[i][3] = seeds[i].v3;
        seed_tensor_a[i][4] = seeds[i].v4;
