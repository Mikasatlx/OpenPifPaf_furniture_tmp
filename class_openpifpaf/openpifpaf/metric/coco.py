...
###############################################################################################################
        ...
        for pred in predictions:
            ...
            pred_data['category_id'] = int(image_id/1000000)  ## In order to load the evaluation data properly
            pred_data = {
        ...
        if not image_annotations:
            ...
            image_annotations.append({
                'image_id': image_id,
                'category_id': int(image_id/1000000),    ## In order to load the evaluation data properly
